...
class AdminPageViewControllerTest extends AbstractIntegrationTest {
    ...
    @Test
    void listWithAuthenticationReturns200AndResolvesToPageListView() throws Exception {
        mockMvc.perform(get("/admin/pages")
    ...
    void editFormWithAuthenticationReturns200AndResolvesToPageFormView(PageType pageType) throws Exception {
        mockMvc.perform(get("/admin/pages/{pageType}/edit", pageType)
                        .with(user("admin").authorities(new SimpleGrantedAuthority("ROLE_ADMIN"))))
                .andExpect(status().isOk())
                .andExpect(view().name("admin/page/form"));
    }
    ...
    void listRendersCommonAdminLayout() throws Exception {
        Document document = render(get("/admin/pages"));
    ...
    void formRendersCommonAdminLayout() throws Exception {
        Document document = render(get("/admin/pages/{pageType}/edit", PageType.GREETING));
